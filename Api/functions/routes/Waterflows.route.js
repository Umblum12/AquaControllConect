...
waterflows.post('/api/historiales', async (req, res) => {
    try {
...
waterflows.get('/api/historiales/:historial_id', (req, res) => {
    (async () => {
        try {
...
waterflows.get('/api/historiales', async (req, res) => {
    try {
...
waterflows.delete('/api/historiales/:historial_id', async (req, res) => {
    try {
...
waterflows.put('/api/historiales/:historial_id', async (req, res) => {
    try {
        const document = db.collection('historiales')
        .doc(req.params.historial_id);
