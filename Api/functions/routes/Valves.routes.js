...
valves.post('/api/historiales', async (req, res) => {
    try {
...
valves.get('/api/historiales/:historial_id', (req, res) => {
    (async () => {
        try {
...
valves.get('/api/historiales', async (req, res) => {
    try {
...
valves.delete('/api/historiales/:historial_id', async (req, res) => {
    try {
...
valves.put('/api/historiales/:historial_id', async (req, res) => {
    try {
        const document = db.collection('historiales')
        .doc(req.params.historial_id);
